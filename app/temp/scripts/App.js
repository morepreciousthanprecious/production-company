...
window.onload = function () {
	_gsap.TweenMax.to(".animate-logo__red-girl", 2, { scale: 40, ease: _gsap.Power2.easeInOut });
	_gsap.TweenMax.to(".animate-logo__red-path", 2, { fill: "#f05136" });
	_gsap.TweenMax.to(".animate-logo__red-girl", 3, { scale: 300, ease: _gsap.Power2.easeIn, delay: 4 });
	_gsap.TweenMax.to(".animate-logo__red-path", 1, { autoAlpha: 0, delay: 5 });
};

exports.default = AnimateLogo;
...
var MobileMenu = function () {
	function MobileMenu() {
		...
		this.menuContent = (0, _jquery2.default)(".primary-nav");
		this.events();
	}
...
var _AnimateLogo = __webpack_require__(1);

var _AnimateLogo2 = _interopRequireDefault(_AnimateLogo);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var mobileMenu = new _MobileMenu2.default();
var revealOnScroll = new _RevealOnScroll2.default();
var animateLogo = new _AnimateLogo2.default();
